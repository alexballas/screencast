...
// SilencePCMReader yields a constant stream of PCM silence so the encoder
...
// NewSilencePCMReader returns a reader producing silence at the given PCM
// layout, paced to real time in chunks of chunkDuration.
